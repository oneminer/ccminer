...
#define  libnvidia_ml "libnvidia-ml.so"
	...
	hnvml = (nvml_handle *) calloc(1, sizeof(nvml_handle));

	hnvml->nvml_dll = nvml_dll;

	hnvml->nvmlInit = (nvmlReturn_t (*)(void)) wrap_dlsym(hnvml->nvml_dll, "nvmlInit_v2");
	if (!hnvml->nvmlInit)
		hnvml->nvmlInit = (nvmlReturn_t (*)(void)) wrap_dlsym(hnvml->nvml_dll, "nvmlInit");
	hnvml->nvmlDeviceGetCount = (nvmlReturn_t (*)(int *)) wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetCount_v2");
	if (!hnvml->nvmlDeviceGetCount)
		hnvml->nvmlDeviceGetCount = (nvmlReturn_t (*)(int *)) wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetCount");
	hnvml->nvmlDeviceGetHandleByIndex = (nvmlReturn_t (*)(int, nvmlDevice_t *))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetHandleByIndex_v2");
	hnvml->nvmlDeviceGetAPIRestriction = (nvmlReturn_t (*)(nvmlDevice_t, nvmlRestrictedAPI_t, nvmlEnableState_t *))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetAPIRestriction");
	hnvml->nvmlDeviceSetAPIRestriction = (nvmlReturn_t (*)(nvmlDevice_t, nvmlRestrictedAPI_t, nvmlEnableState_t))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceSetAPIRestriction");
	hnvml->nvmlDeviceGetDefaultApplicationsClock = (nvmlReturn_t (*)(nvmlDevice_t, nvmlClockType_t, unsigned int *clock))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetDefaultApplicationsClock");
	hnvml->nvmlDeviceGetApplicationsClock = (nvmlReturn_t (*)(nvmlDevice_t, nvmlClockType_t, unsigned int *clocks))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetApplicationsClock");
	hnvml->nvmlDeviceSetApplicationsClocks = (nvmlReturn_t (*)(nvmlDevice_t, unsigned int mem, unsigned int gpu))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceSetApplicationsClocks");
	hnvml->nvmlDeviceResetApplicationsClocks = (nvmlReturn_t (*)(nvmlDevice_t))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceResetApplicationsClocks");
	hnvml->nvmlDeviceGetSupportedGraphicsClocks = (nvmlReturn_t (*)(nvmlDevice_t, uint32_t mem, uint32_t *num, uint32_t *))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetSupportedGraphicsClocks");
	hnvml->nvmlDeviceGetSupportedMemoryClocks = (nvmlReturn_t (*)(nvmlDevice_t, unsigned int *count, unsigned int *clocksMHz))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetSupportedMemoryClocks");
	hnvml->nvmlDeviceGetClockInfo = (nvmlReturn_t (*)(nvmlDevice_t, nvmlClockType_t, unsigned int *clock))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetClockInfo");
	hnvml->nvmlDeviceGetMaxClockInfo = (nvmlReturn_t (*)(nvmlDevice_t, nvmlClockType_t, unsigned int *clock))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetMaxClockInfo");
	hnvml->nvmlDeviceGetPciInfo = (nvmlReturn_t (*)(nvmlDevice_t, nvmlPciInfo_t *)) wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetPciInfo_v2");
	if (!hnvml->nvmlDeviceGetPciInfo)
		hnvml->nvmlDeviceGetPciInfo = (nvmlReturn_t (*)(nvmlDevice_t, nvmlPciInfo_t *)) wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetPciInfo");
	hnvml->nvmlDeviceGetCurrPcieLinkGeneration = (nvmlReturn_t (*)(nvmlDevice_t, unsigned int *gen))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetCurrPcieLinkGeneration");
	hnvml->nvmlDeviceGetCurrPcieLinkWidth = (nvmlReturn_t (*)(nvmlDevice_t, unsigned int *width))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetCurrPcieLinkWidth");
	hnvml->nvmlDeviceGetMaxPcieLinkGeneration = (nvmlReturn_t (*)(nvmlDevice_t, unsigned int *gen))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetMaxPcieLinkGeneration");
	hnvml->nvmlDeviceGetMaxPcieLinkWidth = (nvmlReturn_t (*)(nvmlDevice_t, unsigned int *width))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetMaxPcieLinkWidth");
	hnvml->nvmlDeviceGetPowerUsage = (nvmlReturn_t (*)(nvmlDevice_t, unsigned int *))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetPowerUsage");
	hnvml->nvmlDeviceGetPowerManagementDefaultLimit = (nvmlReturn_t (*)(nvmlDevice_t, unsigned int *limit))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetPowerManagementDefaultLimit");
	hnvml->nvmlDeviceGetPowerManagementLimit = (nvmlReturn_t (*)(nvmlDevice_t, unsigned int *limit))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetPowerManagementLimit");
	hnvml->nvmlDeviceGetPowerManagementLimitConstraints = (nvmlReturn_t (*)(nvmlDevice_t, unsigned int *min, unsigned int *max))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetPowerManagementLimitConstraints");
	hnvml->nvmlDeviceSetPowerManagementLimit = (nvmlReturn_t (*)(nvmlDevice_t, unsigned int limit))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceSetPowerManagementLimit");
	hnvml->nvmlDeviceGetName = (nvmlReturn_t (*)(nvmlDevice_t, char *, int))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetName");
	hnvml->nvmlDeviceGetTemperature = (nvmlReturn_t (*)(nvmlDevice_t, int, unsigned int *))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetTemperature");
	hnvml->nvmlDeviceGetFanSpeed = (nvmlReturn_t (*)(nvmlDevice_t, unsigned int *))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetFanSpeed");
	hnvml->nvmlDeviceGetPerformanceState = (nvmlReturn_t (*)(nvmlDevice_t, int *))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetPerformanceState"); /* or nvmlDeviceGetPowerState */
	hnvml->nvmlDeviceGetSerial = (nvmlReturn_t (*)(nvmlDevice_t, char *, unsigned int))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetSerial");
	hnvml->nvmlDeviceGetUUID = (nvmlReturn_t (*)(nvmlDevice_t, char *, unsigned int))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetUUID");
	hnvml->nvmlDeviceGetVbiosVersion = (nvmlReturn_t (*)(nvmlDevice_t, char *, unsigned int))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetVbiosVersion");
	hnvml->nvmlSystemGetDriverVersion = (nvmlReturn_t (*)(char *, unsigned int))
		wrap_dlsym(hnvml->nvml_dll, "nvmlSystemGetDriverVersion");
	hnvml->nvmlErrorString = (char* (*)(nvmlReturn_t))
		wrap_dlsym(hnvml->nvml_dll, "nvmlErrorString");
	hnvml->nvmlShutdown = (nvmlReturn_t (*)())
		wrap_dlsym(hnvml->nvml_dll, "nvmlShutdown");
	// v331
	hnvml->nvmlDeviceGetEnforcedPowerLimit = (nvmlReturn_t (*)(nvmlDevice_t, unsigned int *limit))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetEnforcedPowerLimit");
	// v340
#ifdef __linux__
	hnvml->nvmlDeviceClearCpuAffinity = (nvmlReturn_t (*)(nvmlDevice_t))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceClearCpuAffinity");
	hnvml->nvmlDeviceGetCpuAffinity = (nvmlReturn_t (*)(nvmlDevice_t, unsigned int sz, unsigned long *cpuSet))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetCpuAffinity");
	hnvml->nvmlDeviceSetCpuAffinity = (nvmlReturn_t (*)(nvmlDevice_t))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceSetCpuAffinity");
#endif
	// v346
	hnvml->nvmlDeviceGetPcieThroughput = (nvmlReturn_t (*)(nvmlDevice_t, nvmlPcieUtilCounter_t, unsigned int *value))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetPcieThroughput");
	// v36x (API 8 / Pascal)
	hnvml->nvmlDeviceGetClock = (nvmlReturn_t (*)(nvmlDevice_t, nvmlClockType_t clockType, nvmlClockId_t clockId, unsigned int *clockMHz))
		wrap_dlsym(hnvml->nvml_dll, "nvmlDeviceGetClock");

	if (hnvml->nvmlInit == NULL ||
			hnvml->nvmlShutdown == NULL ||
			hnvml->nvmlErrorString == NULL ||
			hnvml->nvmlDeviceGetCount == NULL ||
			hnvml->nvmlDeviceGetHandleByIndex == NULL ||
			hnvml->nvmlDeviceGetPciInfo == NULL ||
			hnvml->nvmlDeviceGetName == NULL)
	{
		if (opt_debug)
			applog(LOG_DEBUG, "Failed to obtain required NVML function pointers");
		wrap_dlclose(hnvml->nvml_dll);
		free(hnvml);
		return NULL;
	}

	hnvml->nvmlInit();
	if (hnvml->nvmlSystemGetDriverVersion)
		hnvml->nvmlSystemGetDriverVersion(driver_version, sizeof(driver_version));
	hnvml->nvmlDeviceGetCount(&hnvml->nvml_gpucount);
	...
	if (cudaGetDeviceCount(&hnvml->cuda_gpucount) != cudaSuccess) {
		if (opt_debug)
	...
	hnvml->devs = (nvmlDevice_t *) calloc(hnvml->nvml_gpucount, sizeof(nvmlDevice_t));
	hnvml->nvml_pci_domain_id = (unsigned int*) calloc(hnvml->nvml_gpucount, sizeof(unsigned int));
	hnvml->nvml_pci_bus_id = (unsigned int*) calloc(hnvml->nvml_gpucount, sizeof(unsigned int));
	hnvml->nvml_pci_device_id = (unsigned int*) calloc(hnvml->nvml_gpucount, sizeof(unsigned int));
	hnvml->nvml_pci_subsys_id = (unsigned int*) calloc(hnvml->nvml_gpucount, sizeof(unsigned int));
	hnvml->nvml_cuda_device_id = (int*) calloc(hnvml->nvml_gpucount, sizeof(int));
	hnvml->cuda_nvml_device_id = (int*) calloc(hnvml->cuda_gpucount, sizeof(int));
	hnvml->app_clocks = (nvmlEnableState_t*) calloc(hnvml->nvml_gpucount, sizeof(nvmlEnableState_t));

	/* Obtain GPU device handles we're going to need repeatedly... */
	for (i=0; i<hnvml->nvml_gpucount; i++) {
		hnvml->nvmlDeviceGetHandleByIndex(i, &hnvml->devs[i]);
	}
	...
	for (i=0; i<hnvml->nvml_gpucount; i++) {
		...
		hnvml->nvmlDeviceGetPciInfo(hnvml->devs[i], &pciinfo);
		hnvml->nvml_pci_domain_id[i] = pciinfo.domain;
		hnvml->nvml_pci_bus_id[i]    = pciinfo.bus;
		hnvml->nvml_pci_device_id[i] = pciinfo.device;
		hnvml->nvml_pci_subsys_id[i] = pciinfo.pci_subsystem_id;

		hnvml->app_clocks[i] = NVML_FEATURE_UNKNOWN;
		if (hnvml->nvmlDeviceSetAPIRestriction) {
			hnvml->nvmlDeviceSetAPIRestriction(hnvml->devs[i], NVML_RESTRICTED_API_SET_APPLICATION_CLOCKS,
				NVML_FEATURE_ENABLED);
			/* there is only this API_SET_APPLICATION_CLOCKS on the 750 Ti (340.58) */
		}
		if (hnvml->nvmlDeviceGetAPIRestriction) {
			hnvml->nvmlDeviceGetAPIRestriction(hnvml->devs[i], NVML_RESTRICTED_API_SET_APPLICATION_CLOCKS,
				&hnvml->app_clocks[i]);
		}
	}
	...
	for (i=0; i<hnvml->nvml_gpucount; i++) {
		hnvml->nvml_cuda_device_id[i] = -1;
	}
	for (i=0; i<hnvml->cuda_gpucount; i++) {
		cudaDeviceProp props;
		hnvml->cuda_nvml_device_id[i] = -1;

		if (cudaGetDeviceProperties(&props, i) == cudaSuccess) {
			device_bus_ids[i] = props.pciBusID;
			for (int j = 0; j < hnvml->nvml_gpucount; j++) {
				if ((hnvml->nvml_pci_domain_id[j] == (uint32_t) props.pciDomainID) &&
				    (hnvml->nvml_pci_bus_id[j]    == (uint32_t) props.pciBusID) &&
				    (hnvml->nvml_pci_device_id[j] == (uint32_t) props.pciDeviceID)) {
					if (opt_debug)
						applog(LOG_DEBUG, "CUDA GPU %d matches NVML GPU %d by busId %u",
							i, j, (uint32_t) props.pciBusID);
					hnvml->nvml_cuda_device_id[j] = i;
					hnvml->cuda_nvml_device_id[i] = j;
				}
			}
		}
	}
...
int nvml_set_clocks(int dev_id)
{
	...
	if (hnvml->app_clocks[n] != NVML_FEATURE_ENABLED) {
	...
	if (!mem_prev)
		hnvml->nvmlDeviceGetApplicationsClock(hnvml->devs[n], NVML_CLOCK_MEM, &mem_prev);
	uint32_t gpu_prev = clock_prev[dev_id];
	if (!gpu_prev)
		hnvml->nvmlDeviceGetApplicationsClock(hnvml->devs[n], NVML_CLOCK_GRAPHICS, &gpu_prev);

	hnvml->nvmlDeviceGetDefaultApplicationsClock(hnvml->devs[n], NVML_CLOCK_MEM, &mem_clk);
	rc = hnvml->nvmlDeviceGetDefaultApplicationsClock(hnvml->devs[n], NVML_CLOCK_GRAPHICS, &gpu_clk);
	if (rc != NVML_SUCCESS) {
	...
	hnvml->nvmlDeviceGetSupportedMemoryClocks(hnvml->devs[n], &nclocks, NULL);
	nclocks = min(nclocks, 32);
	if (nclocks)
		hnvml->nvmlDeviceGetSupportedMemoryClocks(hnvml->devs[n], &nclocks, mem_clocks);
	...
	nclocks = 0;
	hnvml->nvmlDeviceGetSupportedGraphicsClocks(hnvml->devs[n], mem_clk, &nclocks, NULL);
	if (nclocks) {
		if (opt_debug)
		...
		hnvml->nvmlDeviceGetSupportedGraphicsClocks(hnvml->devs[n], mem_clk, &nclocks, gpu_clocks);
		for (uint8_t u=0; u < nclocks; u++) {
	...
	rc = hnvml->nvmlDeviceSetApplicationsClocks(hnvml->devs[n], mem_clk, gpu_clk);
	if (rc == NVML_SUCCESS)
		applog(LOG_INFO, "GPU #%d: application clocks set to %u/%u", dev_id, mem_clk, gpu_clk);
	else {
		applog(LOG_WARNING, "GPU #%d: %u/%u - %s (NVML)", dev_id, mem_clk, gpu_clk, hnvml->nvmlErrorString(rc));
		return -1;
	}
...
int nvml_reset_clocks(int dev_id)
{
	...
	if (clock_prev[dev_id]) {
		rc = hnvml->nvmlDeviceResetApplicationsClocks(hnvml->devs[n]);
		if (rc != NVML_SUCCESS) {
	...
	if (limit_prev[dev_id]) {
		...
		if (hnvml->nvmlDeviceGetPowerManagementDefaultLimit && !plimit) {
			rc = hnvml->nvmlDeviceGetPowerManagementDefaultLimit(hnvml->devs[n], &plimit);
		} else if (plimit) {
			rc = NVML_SUCCESS;
		}
		if (rc == NVML_SUCCESS)
			hnvml->nvmlDeviceSetPowerManagementLimit(hnvml->devs[n], plimit);
		ret = 1;
	}
	return ret;
}
...
int nvml_set_pstate(int dev_id)
{
	...
	if (nclocks) {
		gpu_clocks = (uint32_t*) calloc(1, sizeof(uint32_t) * nclocks + 4);
		rc = hnvml->nvmlDeviceGetSupportedGraphicsClocks(hnvml->devs[n], mem_clk, &nclocks, gpu_clocks);
		if (rc == NVML_SUCCESS) {
	...
	if (rc != NVML_SUCCESS) {
		applog(LOG_WARNING, "GPU #%d: pstate P%d (%u/%u) %s", dev_id, (int) wanted_pstate,
			mem_clk, gpu_clk, hnvml->nvmlErrorString(rc));
		return -1;
	}
...
int nvml_set_plimit(int dev_id)
{
	...
	if (!hnvml->nvmlDeviceSetPowerManagementLimit)
		return -ENOSYS;

	uint32_t plimit = device_plimit[dev_id] * 1000;
	uint32_t pmin = 1000, pmax = 0, prev_limit = 0;
	if (hnvml->nvmlDeviceGetPowerManagementLimitConstraints)
		rc = hnvml->nvmlDeviceGetPowerManagementLimitConstraints(hnvml->devs[n], &pmin, &pmax);

	if (rc != NVML_SUCCESS) {
		if (!hnvml->nvmlDeviceGetPowerManagementLimit)
			return -ENOSYS;
	}
	hnvml->nvmlDeviceGetPowerManagementLimit(hnvml->devs[n], &prev_limit);
	if (!pmax) pmax = prev_limit;

	plimit = min(plimit, pmax);
	plimit = max(plimit, pmin);
	rc = hnvml->nvmlDeviceSetPowerManagementLimit(hnvml->devs[n], plimit);
	if (rc != NVML_SUCCESS) {
		applog(LOG_WARNING, "GPU #%d: plimit %s", dev_id, hnvml->nvmlErrorString(rc));
		return -1;
	}
...
{
	*gpucount = hnvml->nvml_gpucount;
	return 0;
}

int cuda_get_gpucount(int *gpucount)
{
	*gpucount = hnvml->cuda_gpucount;
	return 0;
}
...
int nvml_get_gpu_name(int cudaindex, char *namebuf, int bufsize)
{
	...
	if (gpuindex < 0 || gpuindex >= hnvml->nvml_gpucount)
		return -ENODEV;

	if (!hnvml->nvmlDeviceGetName)
		return -ENOSYS;

	if (hnvml->nvmlDeviceGetName(hnvml->devs[gpuindex], namebuf, bufsize) != NVML_SUCCESS)
		return -1;
...
int nvml_get_tempC(int cudaindex, unsigned int *tempC)
{
	nvmlReturn_t rc;
	int gpuindex = hnvml->cuda_nvml_device_id[cudaindex];
	if (gpuindex < 0 || gpuindex >= hnvml->nvml_gpucount)
	...
	if (!hnvml->nvmlDeviceGetTemperature)
		return -ENOSYS;

	rc = hnvml->nvmlDeviceGetTemperature(hnvml->devs[gpuindex], 0u /* NVML_TEMPERATURE_GPU */, tempC);
	if (rc != NVML_SUCCESS) {
		return -1;
	}
...
int nvml_get_fanpcnt(int cudaindex, unsigned int *fanpcnt)
{
	nvmlReturn_t rc;
	int gpuindex = hnvml->cuda_nvml_device_id[cudaindex];
	if (gpuindex < 0 || gpuindex >= hnvml->nvml_gpucount)
	...
	if (!hnvml->nvmlDeviceGetFanSpeed)
		return -ENOSYS;

	rc = hnvml->nvmlDeviceGetFanSpeed(hnvml->devs[gpuindex], fanpcnt);
	if (rc != NVML_SUCCESS) {
		return -1;
	}
...
int nvml_get_current_clocks(int cudaindex, uint32_t *graphics_clock, uint32_t *mem_clock)
{
	...
	rc = hnvml->nvmlDeviceGetClockInfo(hnvml->devs[gpuindex], NVML_CLOCK_GRAPHICS, graphics_clock);
...
int nvml_get_power_usage(int cudaindex, unsigned int *milliwatts)
{
	int gpuindex = hnvml->cuda_nvml_device_id[cudaindex];
	if (gpuindex < 0 || gpuindex >= hnvml->nvml_gpucount)
		return -ENODEV;

	if (!hnvml->nvmlDeviceGetPowerUsage)
		return -ENOSYS;

	nvmlReturn_t res = hnvml->nvmlDeviceGetPowerUsage(hnvml->devs[gpuindex], milliwatts);
	if (res != NVML_SUCCESS) {
		//if (opt_debug)
		//	applog(LOG_DEBUG, "nvmlDeviceGetPowerUsage: %s", hnvml->nvmlErrorString(res));
		return -1;
	}
...
/* Not Supported on 750Ti 340.23 */
int nvml_get_pstate(int cudaindex, int *pstate)
{
	int gpuindex = hnvml->cuda_nvml_device_id[cudaindex];
	if (gpuindex < 0 || gpuindex >= hnvml->nvml_gpucount)
		return -ENODEV;

	if (!hnvml->nvmlDeviceGetPerformanceState)
		return -ENOSYS;

	nvmlReturn_t res = hnvml->nvmlDeviceGetPerformanceState(hnvml->devs[gpuindex], pstate);
	if (res != NVML_SUCCESS) {
		//if (opt_debug)
		//	applog(LOG_DEBUG, "nvmlDeviceGetPerformanceState: %s", hnvml->nvmlErrorString(res));
		return -1;
	}
...
int nvml_get_busid(int cudaindex, int *busid)
{
	int gpuindex = hnvml->cuda_nvml_device_id[cudaindex];
	if (gpuindex < 0 || gpuindex >= hnvml->nvml_gpucount)
		return -ENODEV;

	(*busid) = hnvml->nvml_pci_bus_id[gpuindex];
	return 0;
}

int nvml_get_serial(int cudaindex, char *sn, int maxlen)
{
	uint32_t subids = 0;
	...
	if (hnvml->nvmlDeviceGetSerial) {
		res = hnvml->nvmlDeviceGetSerial(hnvml->devs[gpuindex], sn, maxlen);
		if (res == NVML_SUCCESS)
			return 0;
	}

	if (!hnvml->nvmlDeviceGetUUID)
		return -ENOSYS;
	...
	res = hnvml->nvmlDeviceGetUUID(hnvml->devs[gpuindex], uuid, sizeof(uuid)-1);
	if (res != NVML_SUCCESS) {
		if (opt_debug)
			applog(LOG_DEBUG, "nvmlDeviceGetUUID: %s", hnvml->nvmlErrorString(res));
		return -1;
	}
...
int nvml_get_bios(int cudaindex, char *desc, int maxlen)
{
	uint32_t subids = 0;
	int gpuindex = hnvml->cuda_nvml_device_id[cudaindex];
	if (gpuindex < 0 || gpuindex >= hnvml->nvml_gpucount)
	...
	if (!hnvml->nvmlDeviceGetVbiosVersion)
		return -ENOSYS;

	nvmlReturn_t res = hnvml->nvmlDeviceGetVbiosVersion(hnvml->devs[gpuindex], desc, maxlen);
	if (res != NVML_SUCCESS) {
		if (opt_debug)
			applog(LOG_DEBUG, "nvmlDeviceGetVbiosVersion: %s", hnvml->nvmlErrorString(res));
		return -1;
	}
	return 0;
}

int nvml_get_info(int cudaindex, uint16_t &vid, uint16_t &pid)
{
	uint32_t subids = 0;
	int gpuindex = hnvml->cuda_nvml_device_id[cudaindex];
	if (gpuindex < 0 || gpuindex >= hnvml->nvml_gpucount)
	...
	subids = hnvml->nvml_pci_subsys_id[gpuindex];
	if (!subids) subids = hnvml->nvml_pci_device_id[gpuindex];
	pid = subids >> 16;
	vid = subids & 0xFFFF;
	// Colorful and Inno3D
	if (pid == 0) pid = hnvml->nvml_pci_device_id[gpuindex] >> 16;
	return 0;
}
...
int nvml_destroy()
{
	...
	free(hnvml->nvml_pci_bus_id);
	free(hnvml->nvml_pci_device_id);
	free(hnvml->nvml_pci_domain_id);
	free(hnvml->nvml_pci_subsys_id);
	free(hnvml->nvml_cuda_device_id);
	free(hnvml->cuda_nvml_device_id);
	free(hnvml->app_clocks);
	free(hnvml->devs);
...
unsigned int gpu_fanpercent(struct cgpu_info *gpu)
{
	unsigned int pct = 0;
	if (hnvml) {
		nvml_get_fanpcnt(gpu->gpu_id, &pct);
	}
#ifdef WIN32
	else {
		unsigned int rpm = 0;
...
int gpu_pstate(struct cgpu_info *gpu)
{
	...
	int support = -1;
	if (hnvml) {
		support = nvml_get_pstate(gpu->gpu_id, &pstate);
	}
#ifdef WIN32
	if (support == -1) {
		unsigned int pst = 0;
...
int gpu_busid(struct cgpu_info *gpu)
{
	...
	int support = -1;
	if (hnvml) {
		support = nvml_get_busid(gpu->gpu_id, &busid);
	}
#ifdef WIN32
	if (support == -1) {
...
unsigned int gpu_power(struct cgpu_info *gpu)
{
	...
	int support = -1;
	if (hnvml) {
		support = nvml_get_power_usage(gpu->gpu_id, &mw);
	}
#ifdef WIN32
	if (support == -1) {
		unsigned int pct = 0;
...
int gpu_info(struct cgpu_info *gpu)
{
	...
	if (hnvml) {
		...
		nvml_get_info(id, gpu->gpu_vid, gpu->gpu_pid);
		nvml_get_serial(id, gpu->gpu_sn, sizeof(gpu->gpu_sn));
		nvml_get_bios(id, gpu->gpu_desc, sizeof(gpu->gpu_desc));
	}
#ifdef WIN32
